...
export const BrainCircuitIcon: React.FC<IconProps> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="M12 2a2.5 2.5 0 0 1 2.5 2.5v0a2.5 2.5 0 0 1-2.5 2.5h-1a2.5 2.5 0 0 0-2.5 2.5v0a2.5 2.5 0 0 0 2.5 2.5h3a2.5 2.5 0 0 1 2.5 2.5v0a2.5 2.5 0 0 1-2.5 2.5h-1a2.5 2.5 0 0 0-2.5 2.5v0a2.5 2.5 0 0 0 2.5 2.5" />
    <path d="M16 4.5a2.5 2.5 0 0 0-2.5-2.5" />
    <path d="M18 12h-3" />
    <path d="M12 12h-3" />
    <path d="M12 22v-2.5" />
    <path d="M15 19.5a2.5 2.5 0 0 0 2.5-2.5" />
    <path d="M9 19.5a2.5 2.5 0 0 1-2.5-2.5" />
    <path d="M6 12h3" />
    <path d="M8 4.5a2.5 2.5 0 0 1 2.5-2.5" />
    <path d="M12 2v2.5" />
  </svg>
);
